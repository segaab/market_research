...
def fetch_cot_data(cot_name: str, start_date: str, end_date: str) -> pd.DataFrame:
    ...
    df["timestamp"] = df["report_date_as_yyyy_mm_dd"]                  # NEW
...
def merge_cot_price(cot: pd.DataFrame, price: pd.DataFrame) -> pd.DataFrame:
    ...
    # Align Friday release to trading day as previously
    cot = cot.copy()
...
def return_accuracy_tree(
    ...
    # Map our internal category names to SeasonalMap top-level keys
